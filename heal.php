<html>
<head></head>
<title>Jezzy's Healer Gear Calculator</title>
<body>
</tr>
<?php
...
$headid = $HealLeft_id;
$bodyid = $HealLeft_id + 1;
$glovesid = $HealLeft_id + 2;
$legsid = $HealLeft_id + 3;
$feetid = $HealLeft_id + 4;
$waistid = $HealLeft_id + 5;
$earid = $HealRight_id;
$neckid = $HealRight_id + 5;
$wristid = $HealRight_id + 10;
$ringid = $HealRight_id + 15;
//////////////End Gear ID numbers//////////////
