<html>
<head></head>
<title>Jezzy's Casting Gear Calculator</title>
<body>
</tr>
<?php
...
$headid = $CastLeft_id;
$bodyid = $CastLeft_id + 1;
$glovesid = $CastLeft_id + 2;
$legsid = $CastLeft_id + 3;
$feetid = $CastLeft_id + 4;
$waistid = $CastLeft_id + 5;
$earid = $CastRight_id;
$neckid = $CastRight_id + 5;
$wristid = $CastRight_id + 10;
$ringid = $CastRight_id + 15;
//////////////End Gear ID numbers//////////////
